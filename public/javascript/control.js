...
$(document).on("click", ".icon", function (event) {
    ...
    $('.editLevelBtn').before(`<button type="button" class="btn btn-danger deleteLevelBtn">Delete</button>`);
...
$(document).on("click", ".editTopic", function () {
    ...
    $('.editTopicBtn').before(`<button type="button" class="btn btn-danger deleteTopicBtn">Delete</button>`);
...
function displayTopic(data, name) {
    ...
    container.innerHTML = "";
    container.innerHTML +=     
    `<div class="col-12 text-center"><button class="btn btn-outline-warning addTopic " id="${data._id}" data-bs-toggle="modal" 
    data-bs-target="#topicModal">Add topic</button></div>`
